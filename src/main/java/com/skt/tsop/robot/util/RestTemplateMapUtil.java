 ...
 */
@Component
public class RestTemplateMapUtil {
    /**
     * Logger.
     */
    private static final Logger logger = LoggerFactory.getLogger(RestTemplateMapUtil.class);
    /**
     * RestTemplate.
     */
    @Autowired
    ...
    public Map<String, Object> restTemplate(String url, HttpMethod httpMethod, HttpHeaders headers, Map<String, Object> bodyMap) {
